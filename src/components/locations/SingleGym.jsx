    ...
    return (
      <Box sx={{
        ...
        <Typography
          ...
          sx={{ py: 2, color: theme => theme.palette.common.white, }}
        >
          {gymInfo.name}
        </Typography>
        <Container
        ...
        >
          ...
          <Typography
            ...
            className="centered-text"
          >
            {gymInfo.address}</Typography>
          <Typography
            variant="h6"
            className="centered-text"
          >
            {gymInfo.phoneNumber}</Typography>
          <Typography
            variant="h6"
            className="centered-text"
          >
            {`Facebook: ${gymInfo.facebook !== null ? gymInfo.facebook : 'None available'}`}
          </Typography>
          <Typography
            variant="h6"
            className="centered-text"
          >
            {`Instagram: ${gymInfo.instagram !== null ? gymInfo.instagram : 'None available'}`}
          </Typography>
          <Typography
            variant="h6"
            className="centered-text"
          >
            {`Twitter: ${gymInfo.twitter !== null ? gymInfo.twitter : 'None available'}`}
          </Typography>
          <Typography
            variant="h4"
            className="centered-text"
          ...
          <List
            ...
            data-testid="head-setter-container"
          >
            <ListItem>
              <ListItemText key={headSetter?.id} className="centered-text inside-bullet">
                <Link to={`/employees/${headSetter?.id || ''}`}>
                  {`${headSetter?.firstName || 'Not'} ${headSetter?.lastName || 'Available'}`}
                </Link>
              </ListItemText>
            </ListItem>
          </List>
          ...
          <List
            sx={{ bgcolor: theme => theme.palette.common.white}}
            data-testid="full-time-setters-container"
          >
            {
          ...
          <List
            sx={{ bgcolor: theme => theme.palette.common.white,}}
            data-testid="part-time-setters-container"
          >
          {
