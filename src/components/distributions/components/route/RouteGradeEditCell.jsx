...
const RouteGradeEditCell = ({row, field, id, value, valueOptions}) => {
  ...
  return (
    ...
    >
      {
        valueOptions?.map((routeGrade) => (
          <MenuItem key={routeGrade} value={routeGrade}>{routeGrade}</MenuItem>
        ))
      }
    </Select>
  )
...
export default RouteGradeEditCell;